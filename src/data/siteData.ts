...
export const projects = [
  {
    ...
    description: 'A stunning custom home designed to tailored specifications, showcasing premium finishes and modern architectural elegance.',
    image: builderCustomLuxuryImg,
    gallery: [
      builderCustomLuxuryImg,
      builderCustomLivingGenImg,
    ...
    year: 2024,
    duration: '12 months',
    scope: ['New home construction', 'Custom design', 'Premium finishes'],
