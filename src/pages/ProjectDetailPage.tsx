        ...
        <section className="section-padding bg-secondary">
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {(() => {
                // Clone first image if gallery has 6 items to fill the grid
                const displayGallery = [...project.gallery];
                if (displayGallery.length === 6) {
                  displayGallery.push(displayGallery[0]);
                }

                return displayGallery.map((image, index) => {
                  const isWide = index === 0 || (displayGallery.length === 7 && index === 6);
                ...
                >
                  <CarouselContent className="-ml-4">
                    {relatedProjects.map((relatedProject, index) => (
                      <CarouselItem key={relatedProject.id} className="pl-4 md:basis-1/2 lg:basis-1/3">
                        <motion.div
                          initial={{ opacity: 0, y: 20 }}
                          whileInView={{ opacity: 1, y: 0 }}
                          viewport={{ once: true }}
                        ...
                        >
                          <Link
                            ...
                            className="group block rounded-2xl overflow-hidden shadow-custom-md hover:shadow-custom-lg transition-shadow h-full"
                          >
                            <div className="relative aspect-[16/9] overflow-hidden h-full">
                              <img
